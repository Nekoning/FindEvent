...
public class GeoHash {
	// Encoding: transfer bit to character 
	private static final String BASE_32 = "0123456789bcdefghjkmnpqrstuywxyz";
	...
	public static String encodeGeohash(double latitude, double longtitude, int precision) {
		...
		while (geohash.length() < precision) {
			if (isEven) {
				base32CharIndex = (base32CharIndex << 1) | divideRangeByValue(longtitude, lonRange);
			} else {
